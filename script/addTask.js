(function() {
  ...
  var selectedList = "";
    // Array of Week Days
  var weekDays = ["monList", "tueList", "wedList", "thuList", "friList", "satList"];
  var selectedDay = "";
  ...
  // Checking if logged in and ready
  firebase.auth().onAuthStateChanged(function(user) {
    if (user) {
      ...
      addBtn.addEventListener('click', e => {
        ...
        ref.child("users").child(userId).child("weeks").child("week1").child(selectedDay).push().update({task: task.value});
      ...
      wedAdd.addEventListener('click', e => {
        ...
        selectedList = lists[2];
        selectedDay = weekDays[2];
      });
      ...
      thuAdd.addEventListener('click', e => {
        ...
        selectedList = lists[3];
        selectedDay = weekDays[3];
      });
      ...
      friAdd.addEventListener('click', e => {
        ...
        selectedList = lists[4];
        selectedDay = weekDays[4];
      });
      ...
      satAdd.addEventListener('click', e => {
        ...
        selectedList = lists[5];
        selectedDay = weekDays[5];
      });
    } else {
